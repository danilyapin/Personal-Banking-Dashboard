...
class AccountControllerTest {
    ...
    void getAccounts() throws Exception {
        ...
        mockAccount.setType(AccountType.CHECKING);
        ...
        mockAccount1.setType(AccountType.CHECKING);
        ...
        mockMvc.perform(get("/api/accounts")
                ...
                .andExpect(jsonPath("$[0].type").value(mockAccount.getType().name()))
                ...
                .andExpect(jsonPath("$[1].type").value(mockAccount1.getType().name()))
    ...
    void getAccountById() throws Exception {
        ...
        mockAccount.setUserId("user1234");
        mockAccount.setName("Main Account");
        mockAccount.setType(AccountType.INVESTMENT);
        mockAccount.setBalance(500.0);
        ...
        mockMvc.perform(get("/api/accounts/1234")
                ...
                .andExpect(jsonPath("$.type").value(mockAccount.getType().name()))
    ...
    void createAccount() throws Exception {
        ...
        mockAccountDTO.setType(AccountType.SAVINGS);
    ...
    void deleteAccountById() throws Exception {
        AccountDTO mockAccountDTO = new AccountDTO();
        mockAccountDTO.setName("Main Account");
        mockAccountDTO.setType(AccountType.INVESTMENT);
        mockAccountDTO.setBalance(500.0);
